...
const Mainsection = () => {
	...
	const _handleRefreshSearch = () => {
		setFilter({ ...filter, status: "", roomId: "", pageIndex: 1, pageSize: 10 });
		form.setFieldsValue({ status: "", roomId: "" });
	};
	const columns: ColumnsType<DataType> = [
		...
		},
		{
			...
			width: "120px",
			render: (text) => (
				<img src={BASE_URL_AVT + text} width={"80px"} height={"80px"} alt="" />
			),
		},
		{
			title: "Tên nội thất",
